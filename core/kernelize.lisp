...
(uiop:define-package :petalisp/core/kernelize
...
(defun call-with-subtree-fragment-information
  ...
  (let ((sources (make-array 6 :fill-pointer 0))
        (ranges (copy-array (ranges index-space) :fill-pointer t))
        (source-ids (make-array 6 :fill-pointer 0))
        (transformations (make-array 6 :fill-pointer 0)))
    (labels
