...
;;; Bits 4-7 encode the binary logarithm of the size of the type.  A value
;;; of zero means that the type has no specialized representation.
...
(defun uncached-type-specifier-from-type-code (type-code)
  ...
  (upgraded-array-element-type
   (cond ((zerop (type-code-bits type-code))
          t)
         ;; Complex types.
